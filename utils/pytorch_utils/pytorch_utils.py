...
class EnhancedPointConv(nn.Module):
    ...
    def forward(self, input): # x: (B, C_in, npoint, nsample)
        ...
        print('last fea', last_feat.shape)
        ...
        x = self.activation(self.bn_phi(self.conv_phi(x)))  # group
        print('1', x.shape)
...
# last fea torch.Size([32, 93, 128])
# 1 torch.Size([32, 96, 128, 16])
# 2 torch.Size([32, 96, 128])
# 3 torch.Size([32, 117, 128])
